const messages = {
  ES: {
    ...
    ScheduleSection: {
      ...
      Text:
        'Si no puedes estar presencialmente, puedes conectarte a nuestra reunión, donde transmitiremos la ceremonia y parte de nuestra celebración.',
    },
    PhotosSection: {
    ...
    imagesAlt: {
      ...
      PhotosNotreVie7: 'Fotografía en Salamanca',
  ...
  EN: {
    ...
    imagesAlt: {
      ...
      PhotosNotreVie7: 'Photograph in Salamanca',
...
EN: {
  ...
  imagesAlt: {
    ...
    PhotosNotreVie7: 'Photographie à Salamanque',
